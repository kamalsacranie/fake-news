...
import { SeedTopic } from "../data/development-data/topics";
import { SeedUser } from "../data/development-data/users";
import { SeedArticle } from "../data/development-data/articles";
...
const seed = ({
  ...
  return db
    ...
    .then(({ rows: articleRows }: { rows: Article[] }) => {
